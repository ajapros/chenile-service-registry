...
public class ServiceRegistryCache {
    ...
    public void store(ChenileRemoteServiceDefinition entity) {
        if (entity == null || entity.serviceId == null || entity.serviceVersion == null)
            return;
        ...
        if (sd == null || ServiceRegistryFingerprint.compareVersions(sd.serviceVersion, version) < 0){
    ...
    public boolean exists(ChenileRemoteServiceDefinition entity){
        ...
        return ServiceRegistryFingerprint.semanticallyEquals(csrd, entity);
    }
